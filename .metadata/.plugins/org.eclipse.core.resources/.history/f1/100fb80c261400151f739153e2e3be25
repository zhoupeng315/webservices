 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://service.zttc.org/", wsdlLocation = "http://localhost:8888/ns?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://service.zttc.org/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://service.zttc.org/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.zttc.org/", "MyServiceImplPort"), IMyService.class, features);
    }
